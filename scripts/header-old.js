...
(window.webpackJsonp = window.webpackJsonp || []).push([[0], {
    0: function (e, t, n) {
        ...
        var r = function () {
            ...
            }(), e = document.querySelector("form.main_header__search"), t = e.querySelector("input.main_header__search__input"), document.querySelector("button.handler--search").addEventListener("click", (function (n) {
